...
export default function NotFound() {
  ...
  return (
    <div className="flex items-center justify-center text-gray-800 h-screen overflow-hidden bg-white">
      <div className="grid justify-center items-center">
        ...
        <Link href={`/?userId=${userInfo?._id}`} className="text-center mt-4">
          <button
            type="submit"
