...
const ServiceMediumHeading = ({ title, link, className }) => {
  return (
    <div className="flex justify-between items-center pb-2 lg:w-full w-[96vw] px-7 mb-6">
      <h1
...
export default ServiceMediumHeading
