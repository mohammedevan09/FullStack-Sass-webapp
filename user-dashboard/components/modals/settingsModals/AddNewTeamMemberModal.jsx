...
import { LabelsTwo } from '../../others/Labels'
    ...
    <WrappingModal modalOpen={openModal}>
      <div className="grid justify-center bg-white sm:pt-12 pt-8 pb-4 xs:px-6 px-4 rounded-[20px] overflow-x-hidden gap-7 sm:w-[550px] w-[360px]">
        ...
        <div className="grid w-full items-center gap-6 mx-auto">
          ...
          />
          <div>
            <LabelsTwo name={'Name'} htmlFor={'name'} />
            <Input2
              type="text"
          ...
          <div>
            ...
            />
            <ErrorMessageTwo errors={errors?.email} />
          </div>
          <div>
            <LabelsTwo name={'Phone'} htmlFor={'Phone'} />
            <Input2
              type="number"
              id={'Phone'}
          ...
          <div>
            ...
            />
            <ErrorMessageTwo errors={errors?.password} />
          </div>
        </div>
        <div>
      ...
      {watch(`access[${item.id}].accessOf`)?.length > 0 && (
        <>
          ...
          >
            ...
            <Link
              href={`/dashboard/${item?.id}?userId=${watch('_id')}`}
